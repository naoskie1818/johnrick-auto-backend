...
setTimeout(() => {
    try {
        // Use .prepare().all() to get data immediately
        ...
        console.error('❌ Error updating orders table schema:', err);
    }
}, 1000);
